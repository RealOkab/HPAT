...
function ReadCICs() {
  ...
  return (
    <div className="min-h-screen w-full bg-white/50 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-7xl flex flex-row flex-wrap justify-center gap-6">
        {fetchedData &&
          (fetchedData as DistrictData)?.informationCenters.map((cic, i) => (
            <section
              key={i}
              className="  bg-white/75 p-6 rounded-xl border border-gray-200 shadow hover:shadow-2xl hover:scale-105 transition-transform duration-300 flex flex-col"
            >
              ...
              <button
                className="mt-auto px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition-colors"
                onClick={() => {
